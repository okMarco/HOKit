...
@interface InsVideoViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation InsVideoViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    _data = @[@"http://img.hb.aicdn.com/65f7ccf5d38ae56fb131b1485281b27c7614b1ea546f5-jZzKu3_fw658",
              @"http://img.hb.aicdn.com/ad97b1805fd18f5be3c7a198aa2de0501a833b3628afc-nWmCLK_fw658",
              ...
              @"http://img.hb.aicdn.com/1d0710188c7081ab1f89b492a72fa4135f0b5cdcbda4-zSH9HR_fw658"];
    [self collectionView];
}

- (UICollectionView *)collectionView {
    if (!_collectionView) {
        Ins3DFlowLayout *ins3DFlowLayout = [[Ins3DFlowLayout alloc] init];
        ins3DFlowLayout.itemSize = CGSizeMake(self.view.bounds.size.width, self.view.bounds.size.height);
        ins3DFlowLayout.minimumLineSpacing = 0;
        ins3DFlowLayout.minimumInteritemSpacing = 0;
        ins3DFlowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
        _collectionView = [[UICollectionView alloc] initWithFrame:self.view.bounds collectionViewLayout:ins3DFlowLayout];
        _collectionView.delegate = self;
        _collectionView.dataSource = self;
        _collectionView.pagingEnabled = YES;
        [_collectionView registerClass:InsVideoCell.class forCellWithReuseIdentifier:NSStringFromClass(InsVideoCell.class)];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    InsVideoCell *videoCell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(InsVideoCell.class) forIndexPath:indexPath];
    videoCell.imageUrl = _data[indexPath.row];
    return videoCell;
}
